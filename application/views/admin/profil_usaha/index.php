                ...
                <div class="col-lg-12">
                    ...
                    ?>
                        <div class="card-body">
                            ...
                            <label class="font-weight-bold">Jam Operasional:</label> <?= $ps['jam_operasional'] ?><br>
                            ...
                            <div class="text-center">
                                ...
                                <!-- Setelah gambar 3 -->
                                <img class="m-3" src="<?= base_url() ?>assets/dataresto/foto_usaha/<?= $ps['foto_usaha_4'] ?>" width="50%">
                                <img class="m-3" src="<?= base_url() ?>assets/dataresto/foto_usaha/<?= $ps['foto_usaha_5'] ?>" width="50%">
                            </div>
                        <?php
                    } ?>
                        </div>
