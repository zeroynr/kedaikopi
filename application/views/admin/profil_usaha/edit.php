                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <form action="<?= base_url() ?>profilusaha/edit" method="POST" enctype="multipart/form-data">
                                    ...
                                    <input type="text" class="form-control" name="jam_operasional" value="<?= $ps['jam_operasional'] ?>">
                                    <label>Email</label>
                            ...
                            <div class="row">
                                ...
                                <!-- Dalam baris gambar preview -->
                                <div class="col-sm-4">
                                    <div class="text-center">
                                        <img class="m-3" src="<?= base_url() ?>assets/dataresto/foto_usaha/<?= $ps['foto_usaha_4'] ?>" width="100%"><br>
                                        Gambar 4
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="text-center">
                                        <img class="m-3" src="<?= base_url() ?>assets/dataresto/foto_usaha/<?= $ps['foto_usaha_5'] ?>" width="100%"><br>
                                        Gambar 5
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control-file" name="foto_usaha_5" accept=".jpg, .jpeg, .png">
