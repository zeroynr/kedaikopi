                ...
                <div class="col-lg-12">
                    ...
                    <form action="<?= base_url() ?>pembayaran/prosesEdit" method="post" enctype="multipart/form-data">
                        ...
                        foreach ($booking as $b) { ?>
                            ...
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Batas Pembayaran : </label></div>
                                <div class="col-12 col-md-9"> <label><?= $b['batas_pembayaran_dp'] ?></label></div>

                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Jumlah pembayaran Terbayar : </label></div>
                                <div class="col-12 col-md-9"><input type="number" min="0" class="form-control" placeholder="" name="total_sudah_dibayar" required>
                                    <small>* Jika gambar salah/pembayaran kurang isi jumlah pembayaran terbayar dengan angka 0</small>
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <select class="form-control" id="exampleFormControlSelect1" name="status_pembayaran">
                                        <option value="Sudah Bayar" <?php if ($b['status_pembayaran'] == "Sudah Bayar") { ?>selected<?php } ?>>Sudah Bayar</option>
                                        <option value="Belum Bayar" <?php if ($b['status_pembayaran'] == "Belum Bayar") { ?>selected<?php } ?>>Belum Bayar (Gambar Salah/Pembayaran Kurang)</option>
                                    </select>
                                </div>
                            </div>
